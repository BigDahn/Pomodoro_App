...
function SettingsModal() {
  ...
  return (
    ...
    >
      ...
      <button
        className={`px-9 py-2.5 ${initialColor.color} rounded-full relative left-[36.5%] top-[2%] md:left-[40.5%] md:top-[9%] lg:left-[13rem] lg:top-[-20px] ${initialFont} text-white font-bold `}
